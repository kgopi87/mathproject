...
# Maths - Subtraction
@routes.route('/maths/v1/sub', methods=['GET', 'POST'])
def sub():
    ...
    if request.method == 'GET':
        ...
        ans = id1 - id2
        jsonObj = jsonify(id1=id1, id2=id2, Subtracted=ans)
        app.logger.debug("Subtraction completed")
    ...
    if request.method == 'POST':
        ...
        ans = id1 - id2
        jsonObj = jsonify(Subtracted=ans)
        app.logger.debug("Subtraction completed")
